...
// body.on("load", change_map_on_load);

// function change_map_on_load() {
//     d3.csv("db/year.csv").then(function (mortdata) {
//     // processes i/p data - (a) get right year 
//     var yearselected = '2008'
//     for (var i = 0; i < mortdata.length; i++) {
//         var yearvalue = mortdata[i].Year;
//         //console.log(yearvalue);
//         if (yearvalue == yearselected){
...
var submit = d3.select("#loc");
submit.on("change",change_map);

function change_map() {
    d3.csv("db/year.csv",function (mortdata) {
        console.log(mortdata);
    // processes i/p data - (a) get right year 
    var yearselected = d3.select("#loc").property("value"); 
    for (var i = 0; i < mortdata.length; i++) {
        var yearvalue = mortdata[i].Year;
        //console.log(yearvalue);
        if (yearvalue == yearselected){
